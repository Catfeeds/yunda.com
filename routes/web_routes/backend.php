...
//            });
            ...
            // 订单管理
            Route::group(['prefix'=>'/order'],function(){
                Route::any('/','OrderManagementController@index'); //个人订单
                Route::any('personal_details','OrderManagementController@personal_details'); //个人订单详情
                Route::any('enterprise','OrderManagementController@enterprise'); //企业订单
                Route::any('order_company_details','OrderManagementController@order_company_details'); //企业订单
            });

            // 保单管理
            Route::group(['prefix'=>'/policy'],function(){
                Route::any('/','PolicyController@index'); //个人保单
                Route::any('policy_details','PolicyController@policy_details'); //个人保单详情
                Route::any('policy_company','PolicyController@policy_company'); //企业保单
                Route::any('policy_company_details','PolicyController@policy_company_details'); //企业保单详情
                Route::any('export_policy_person','PolicyController@exportPolicyPerson'); //个人保单导出
                Route::any('export_policy_company','PolicyController@exportPolicyCompany'); //企业保单导出
                Route::any('policy_offline','PolicyController@policyOffline'); //线下保单
                Route::any('policy_offline_details','PolicyController@policyOfflineDetails'); //线下保单详情页
                Route::any('update_policy_offline','PolicyController@updatePolicyOffline'); //更新线下保单数据
                Route::any('import_offline','PolicyController@importOffline'); //上传保单文件
