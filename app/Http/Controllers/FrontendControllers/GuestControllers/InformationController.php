...
//    用户修改
    public function modification(){
        ...
        if(empty($email)||empty($address)){
            return '<script>alert("修改内容不能为空！");location.href="/information/guest_info";</script>';
//            return back()->withErrors('修改内容不能为空！');
        }
...
//            return back()->with('status','修改成功');
            ...
            return '<script>alert("修改失败！");location.href="/information/guest_info";</script>';
